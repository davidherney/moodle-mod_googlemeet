...
$string['recordingfilter_help'] = 'Introduce el texto exacto con el que deben comenzar los nombres de las grabaciones. El texto debe estar seguido por un separador, como un espacio, guion o paréntesis. Cuando se configura, solo se sincronizan las grabaciones nuevas que coincidan con este prefijo; las ya sincronizadas se conservan mientras sigan encontrándose en Drive. Déjalo vacío para usar el nombre original del evento de Google Calendar.';
$string['autosynchours'] = 'Horas tras finalizar la sesión para auto-sincronizar';
$string['autosynchours_help'] = 'Horas que hay que esperar tras el final de una sesión programada antes de sincronizar automáticamente las grabaciones de Google Drive. Poner 0 para desactivar (el profesor siempre puede sincronizar manualmente). Cada sesión se intenta una sola vez; si Google Drive aún no ha publicado la grabación, el profesor tendrá que sincronizar manualmente.';

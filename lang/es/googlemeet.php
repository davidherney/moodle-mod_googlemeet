...
$string['recordingfilter_help'] = 'Introduce el texto exacto con el que deben comenzar los nombres de las grabaciones. El texto debe estar seguido por un separador, como un espacio, guion o paréntesis. Cuando se configura, las grabaciones que no coincidan con este prefijo no se sincronizarán. Déjalo vacío para usar el nombre original del evento de Google Calendar.';
